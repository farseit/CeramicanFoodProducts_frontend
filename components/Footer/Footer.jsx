...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#181818] text-[#838790] p-1 md:p-12 lg:p-24 pb-24 md:pb-28 lg:pb-12">
      <div className="grid grid-cols-1 ml-10 md:grid-cols-2 lg:grid-cols-3 gap-12">
        {/* part-1 */}
        <div className="space-y-4 col-span-1">
          ...
          <div className="space-y-3">
            ...
            <p className="flex gap-2 items-center">
              ...
              <span>info@ceramicandfoodproducts.com</span>
            </p>
          </div>
        ...
        {/* Part-3 */}
        <div className="col-span-1  md:ml-20 md:col-span-2  lg:col-span-1 grid gird-cols-1 md:grid-cols-2 gap-10">
      ...
      <div className="flex flex-col ml-10 md:flex-row gap-4 justify-between">
        ...
        <div className="flex flex-col md:flex-row gap-5">
          <span className="text-base hover:underline">
            <Link
              href={"/privacyPolicy"}
              className="text-base hover:underline inline"
            >
              Privacy Policy
            </Link>
          </span>
