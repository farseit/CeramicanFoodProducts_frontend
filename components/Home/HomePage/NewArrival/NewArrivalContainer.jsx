  ...
  return (
    <div className="mt-12">
      ...
      {/* <div className="text-center mb-6">
        <h2 className="text-xl md:text-2xl font-semibold text-[#192a56]">
          New Arrivals
        </h2>
        <p className="text-sm text-gray-500 md:text-base">
          Discover the latest products with exciting offers and deals.
        </p>
      </div> */}
      <SectionTitle
        title="Ceramic Collection"
        description="Discover timeless elegance with our handcrafted ceramic pieces, perfect for adding charm to your everyday living and dining experiences."
      />

      {/* Product Grid */}
      <div className="grid grid-cols-2 md:grid-cols-3 mt-12 lg:grid-cols-6 gap-x-4 gap-y-6">
